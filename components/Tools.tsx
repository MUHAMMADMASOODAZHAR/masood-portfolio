  ...
  const categories: ToolCategory[] = [
    ...
    },
    {
      ...
      tools: [
        {
          name: "Meta Ads",
          desc: "Paid social campaigns",
          logoIcon: (
            <svg className="w-6 h-6 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-label="Meta Ads Logo">
    ...
    },
    {
      ...
      tools: [
        {
          name: "Twilio",
          desc: "SMS & voice gateway",
          logoIcon: (
            <svg className="w-6 h-6 text-red-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-label="Twilio Logo">
        ...
        {
          name: "WhatsApp",
          desc: "Direct customer messaging",
          logoIcon: (
    ...
    },
    {
      ...
      tools: [
        {
          name: "Asana",
          desc: "Task & project management",
          logoIcon: (
            <svg className="w-6 h-6 text-rose-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-label="Asana Logo">
          ...
          {categories.map((cat, idx) => (
            ...
            >
              ...
              <div className="flex items-center gap-2.5 mb-5 pb-3 border-b border-slate-100 dark:border-slate-800">
                ...
                <h3 className="text-xs sm:text-sm font-bold text-slate-950 dark:text-white uppercase tracking-wider">
                  {cat.label}
                </h3>
              </div>
